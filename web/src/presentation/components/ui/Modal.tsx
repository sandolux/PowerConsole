...
export const Modal = ({ isOpen, onClose, title, children, size = 'md', panelClassName = '', bodyClassName = '', showHeader = true }: ModalProps) => {
  if (!isOpen) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      >
        {showHeader && title && ( // Conditionally render header
